        ...
        <div class="w-full max-w-4xl mt-0 mb-4">
            <div class="flex items-center justify-between p-4 bg-white rounded-lg shadow-sm min-h-8 hover:shadow-none">
                ...
                <div class="flex-shrink-0">
                    <h1 class="text-xl font-extrabold sm:text-2xl">Dashboard</h1>
                </div>
                ...
                <div class="flex-shrink-0">
                    <button
                        ...
                        <span class="hidden text-xs md:inline md:text-base">Email me a copy</span></button>
                </div>
            </div>
        </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex items-center justify-end p-0 m-0">
                            <svg viewBox="0 0 36 36" class="circular-chart green h-16 max-h-[92px] w-16 max-w-[92px]"
                                ...
                                a 15.9155 15.9155 0 0 1 0 31.831
                                a 15.9155 15.9155 0 0 1 0 -31.831" />
                                <text x="18" y="20.35" class="font-bold percentage">50
                                    %</text>
                            </svg>
                        </div>
                    </div>
                            ...
                            <div class="flex items-center w-1/2">
                                <svg viewBox="0 0 36 36" class="w-20 h-20 circular-chart green">
                                    <path class="circle-bg" d="M18 2.0845
                                        a 15.9155 15.9155 0 0 1 0 31.831
                                        a 15.9155 15.9155 0 0 1 0 -31.831" />
                                    <path class="circle" stroke-dasharray=", 100" d="M18 2.0845
                                        a 15.9155 15.9155 0 0 1 0 31.831
                                        a 15.9155 15.9155 0 0 1 0 -31.831" />
