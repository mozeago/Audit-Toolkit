...
<body class="antialiased">
    ...
    <div class="bg-cover bg-center sm:max-h-10 md:max-h-32"
        style="background-image: url({{ asset('images/people-impact.webp') }}););">
        <h1
            class="roboto-bold p-8 text-left text-4xl font-bold text-white">
            Our Impact</h1>
    </div>
    <div class="mb-8 bg-gray-100 px-6 py-9 text-black">
        <p class="roboto-regular text-black">The IGNITE
    ...
    <div
        ...
        <div
            class="flex flex-wrap items-center justify-center pb-8">
            ...
            <div class="flex items-center justify-center">
                <a
                    href="https://www.scratchandscript.com/user_contact">
                    <button
                        ...
                        <svg class="h-4 w-10 sm:h-6 sm:w-16"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 52 52"
                        ...
                        <span
                            class="roboto-bold-16 ml-1 font-bold sm:ml-2">Become
                            a Partner</span>
                    </button>
                </a>
            </div>
    ...
    {{-- start report --}}
    <div
        class="mb-8 mt-8 flex flex-col border-b-2 border-gray-100 px-8 shadow-sm">
        <div
            class="container mx-auto mb-4 grid grid-cols-12 items-center justify-center p-4">
            <div class="col-span-3 sm:col-span-4"></div>
            <div class="col-span-1 border-2 border-black">
            </div>
            <div
                class="roboto-bold col-span-6 text-center text-xl font-bold sm:col-span-2">
        ...
        <div class="flex w-full pb-8">
            <div class="flex w-1/2 flex-grow flex-col">
                <img src="{{ asset('images/Annual-report-ignite.webp') }}"
                    alt="Skills Report"
                    class="fade-left-5 rounded-bl-xl rounded-tl-xl">
            </div>
            <div
                class="flex w-1/2 flex-grow flex-col py-0 pl-8">
                <h2
                    class="roboto-bold mb-8 text-xl font-bold leading-snug">
                    <span
                        class="inline-block pb-1 text-[#C8000B]">2024
                        SUB-SAHARA
                    </span>
                    <span
                        class="inline-block pb-1">CYBERSECURITY
                        AND DATA PROTECTION
                        SKILLS REPORT
                </h2>
                <p class="roboto-regular-24 mt-2">
                ...
                <div class="mt-1">
                    <a href="{{ asset('report/IGNITE-Cohort-II-Program.pdf') }}"
                        download>
                        <button
                            ...
                            <span
                                class="roboto-regular ml-1 font-bold uppercase sm:ml-2">read
                                report</span>
    ...
    {{-- Start SDG focus --}}
    <div
        class="mb-16 mt-4 flex flex-col justify-center border-b-2 border-gray-100 px-8 py-8">
        <h1
            class="roboto-bold mb-8 text-start text-xl font-bold">
            Our <span
                class="inline-block border-b-2 border-[#C8000B] pb-1 text-[#C8000B]">SDG</span>
            Focus
        </h1>
        <div
            ...
            <div
                ...
                <a href="https://tinyurl.com/39975atx"
    ...
    <div class="flex w-full items-start pl-8">
        <h2 class="roboto-bold text-xl font-bold">
            <span
                class="inline-block pb-1 uppercase text-[#C8000B]">We
                want to Partner
            </span>
        </h2>
    </div>
    <div class="flex w-full items-start pl-8">
        <h2 class="roboto-bold text-xl font-bold">
            <span
                class="inline-block border-b-2 border-black pb-1 uppercase">With
                You
        </h2>
    </div>
    <div class="flex bg-[#FCF6F6] p-8">
        <div class="w-1/2 flex-grow flex-col">
            <p class="roboto-regular mt-2">To drive forward
            ...
            <ol class="my-4 list-none space-y-2">
                <li
                    class="roboto-regular flex items-start">
                    <span
        ...
        <div class="w-1/2 flex-grow flex-col">
            <img src="{{ asset('images/we_want_to_partner_with_you.webp') }}"
                alt="Image" class="fade-left">
        </div>
    </div>
    {{-- end partnership --}}
