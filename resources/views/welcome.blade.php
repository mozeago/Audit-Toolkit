...
<body class="antialiased">
    ...
    <div class="bg-center bg-cover h-28" style="background-image: url('images/impact-background.jpg');">
        <h1 class="p-8 text-4xl font-bold text-left text-white roboto-bold">Our Impact</h1>
    </div>
    <div class="p-8 text-black bg-[#F7F7F7]">
        <p class="roboto-regular">The IGNITE Youth Training Program is a dynamic initiative designed to train and
            empower
            1million young
    ...
    <div class="flex flex-col items-center justify-center w-full">
        <h1 class="mb-8 text-xl font-bold text-center roboto-bold">IGNITE Partners Worldwide</h1>
        <div class="flex flex-wrap items-center justify-center">
            <div class="flex items-center justify-center">
                <a class="zoom-image" href="https://engage.isaca.org/kenyachapter/home">
                    <img src="{{ asset('images/isacakenya.jpeg') }}" alt="Image 1" class="w-auto h-8 sm:h-12 sm:mx-2">
                </a>
            </div>
            <div class="flex items-center justify-center">
                <a class="zoom-image" href="https://engage.isaca.org/southafricachapter/home">
                    <img src="{{ asset('images/ISACA_South_Africa.jpeg') }}" alt="Image 1"
                        class="w-auto h-8 sm:h-12 sm:mx-2">
                </a>
            </div>
            <div class="flex items-center justify-center">
                <a class="zoom-image" href="https://engage.isaca.org/kampalachapter/home">
                    <img src="{{ asset('images/kampala.jpg') }}" alt="Image 1" class="w-auto h-8 sm:h-12 sm:mx-2">
                </a>
            </div>
            <div class="flex items-center justify-center">
                <a class="zoom-image"
            ...
            <div class="flex items-center justify-center">
                <a class="zoom-image" href="https://engage.isaca.org/rwandachapter/home">
                    <img src="{{ asset('images/rwanda.jpg') }}" alt="Image 1" class="w-auto h-8 sm:h-12 sm:mx-2">
                </a>
            </div>
            <div class="flex items-center justify-center">
            ...
            <div class="flex items-center justify-center">
                <a href="https://www.scratchandscript.com/user_contact">
                    <button
                        class="min-h-8 sm:min-h-12 flex items-center justify-center text-white bg-[#C8000B] rounded hover:shadow-2xl hover:bg-green-800 px-2 sm:px-4 py-1 sm:py-2">
                        <svg class="w-10 h-4 sm:w-16 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 52 52"
                        ...
                        <span class="ml-1 font-bold sm:ml-2 roboto-regular">Become a Partner</span>
                    </button>
                </a>
            </div>
        </div>
    ...
    <div class="flex flex-col items-center justify-center mt-32">
        ...
        <div class="flex p-8">
            <div class="flex-col flex-grow w-1/2">
                ...
                <p class="mt-2 roboto-regular">To drive forward our mission within the IGNITE program, we are actively
                    seeking
