...
<body class="antialiased">
    ...
    <div class="bg-[#FCF6F6] ">
        <div class="flex px-8 rounded-lg">
            <div class="flex px-32">
                <div class="flex-col flex-grow w-2/3">
        ...
        <div class="flex px-36">
            <p class="roboto-regular">
                ...
                <span class="italic font-bold">info[at]scratchandscript.com</span>

            </p>
            <div class="mt-4">
                <a href="https://www.scratchandscript.com/user_contact">
                    <button
                        class="text-nowrap min-h-8 sm:min-h-12 flex items-center justify-center rounded bg-[#C8000B] px-2 py-1 text-white hover:bg-black hover:shadow-2xl sm:px-4 sm:py-2">
