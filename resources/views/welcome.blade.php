    ...
    <div
        ...
        <div class="flex flex-wrap items-center justify-center pb-8 md:flex-nowrap">
            ...
            <div
                ...
                <a href="https://www.scratchandscript.com/user_contact" class="w-full lg:w-auto">
                    <button
                        class="flex items-center rounded bg-[#C8000B] text-white font-bold py-2 px-4  hover:bg-black hover:shadow-2xl">
                        <!-- Icon on the left -->
