        ...
        <div class="flex flex-wrap items-center justify-center pb-8 md:flex-nowrap">
            ...
            <div
                ...
                <a href="https://www.scratchandscript.com/user_contact" class="w-full">
                    <button
                        class="sm:w-full flex items-center justify-center rounded bg-[#C8000B] px-2 py-1 text-white hover:bg-black hover:shadow-2xl sm:px-4 sm:py-2">
                        ...
                        <span class="ml-1 font-semibold sm:ml-2">Become
                            a Partner</span>
                    </button>
                </a>
            </div>
