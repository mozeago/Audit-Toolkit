...
<body class="antialiased">
    ...
    <div class="h-28 bg-cover bg-center"
        style="background-image: url('images/impact-background.jpg');">
        <h1
            class="roboto-bold p-8 text-left text-4xl font-bold text-white">
            Our Impact</h1>
    </div>
    <div class="mb-8 bg-gray-100 px-4 py-8 text-black">
    ...
    {{-- start partners --}}
    <div
        class="flex w-full flex-col items-center justify-center border-b-2 border-gray-100 bg-white pb-8 pt-8">
        <h1
            class="roboto-bold mb-8 text-center text-xl font-bold">
            <span
                class="inline-block border-b-2 border-[#C8000B] pb-4">IGNITE
        ...
        <div
            ...
            <div class="flex items-center justify-center">
                <a class="zoom-image"
                    ...
                    <img src="{{ asset('images/isacakenya.jpeg') }}"
                        alt="Image 1"
            ...
            <div class="flex items-center justify-center">
                <a class="zoom-image"
                    ...
                    <img src="{{ asset('images/ISACA_South_Africa.jpeg') }}"
                        alt="Image 1"
                        class="h-8 w-auto sm:mx-2 sm:h-12">
                </a>
            </div>
            <div class="flex items-center justify-center">
                <a class="zoom-image"
                    ...
                    <img src="{{ asset('images/kampala.jpg') }}"
                        alt="Image 1"
                        class="h-8 w-auto sm:mx-2 sm:h-12">
                </a>
            </div>
            <div class="flex items-center justify-center">
                <a class="zoom-image"
                    ...
                    <img src="{{ asset('images/kenya data privacy.jpeg') }}"
                        alt="Image 1"
                        class="h-8 w-auto sm:mx-2 sm:h-12">
                </a>
            </div>
            <div class="flex items-center justify-center">
                <a class="zoom-image"
                    ...
                    <img src="{{ asset('images/rwanda.jpg') }}"
                        alt="Image 1"
                        class="h-8 w-auto sm:mx-2 sm:h-12">
                </a>
            </div>
            <div class="flex items-center justify-center">
                <a class="zoom-image"
                    ...
                    <img src="{{ asset('images/scratchandscript_logo_red.png') }}"
                        alt="Image 1"
                        class="h-8 w-auto sm:mx-2 sm:h-12">
                </a>
            </div>
            <div class="flex items-center justify-center">
                <a
                    ...
                    <button
                        ...
                        <span
                            class="roboto-regular ml-1 font-bold sm:ml-2">Become
                            a Partner</span>
                    </button>
                </a>
            </div>
    ...
    {{-- end partners --}}
    <div
        class="my-16 flex flex-col justify-center px-8 py-8">
        <h1
            class="roboto-bold mb-8 text-start text-xl font-bold">
            Our SDG <span
                class="inline-block border-b-2 border-[#C8000B] pb-1 text-[#C8000B]">Focus</span>
        </h1>
        <div
    ...
    <div class="flex p-8">
        <div class="w-1/2 flex-grow flex-col">
            <h2 class="roboto-bold mb-8 text-xl font-bold">
                We want to Partner
                With You</h2>
            ...
            <ul class="roboto-regular list-disc pl-8">
