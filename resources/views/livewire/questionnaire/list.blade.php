...
new class extends Component {
    ...
    {
        return [
            'userAnswers.*.organization' => 'required',
            'userAnswers.*.department' => 'required',
    ...
    {
        // Validate organization and department before proceeding
        $this->validate([
            'userAnswers.*.organization' => 'required',
            'userAnswers.*.department' => 'required',
        ]);
...
<div>
    <div class="container px-4 py-8 mx-auto">
        @if (!isset($organization) || !isset($department))
            <div class="mb-4">
                ...
                <form wire:submit.prevent="nextQuestion">
                    <div class="mb-4">
                        ...
                        <input id="organization" type="text" wire:model.defer="userAnswers.*.organization"
