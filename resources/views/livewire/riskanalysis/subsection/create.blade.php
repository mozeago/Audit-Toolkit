...
new class extends Component {
    ...
    {
        return [
            'subSectionText' => 'required|string|max:255',
    ...
    <div class="w-full max-w-md min-w-full px-8 py-6 leading-normal bg-white rounded">
        <form wire:submit.prevent="store">
            <div class="flex flex-col w-full">
                <label for="subSectionText" class="mb-2 text-sm font-semibold">{{ __('Risk Sub-Section Text:') }}</label>
                <input placeholder="{{ __('Risk Sub-Section Text') }}" wire:model="subSectionText" id="subSectionText"
                    type="text"
