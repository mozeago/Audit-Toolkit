...
new class extends Component {
    ...
    public Collection $riskQuestionText;
    ...
    public function mount()
    {
        ...
        $this->riskSubsectionId = $this->riskRecommendation->risk_sub_section_id;
    ...
    {
        $this->riskQuestionText = RiskSubSection::orderBy('created_at', 'desc')->get();
    }
    public function rules()
    {
        return [
            'riskRecommendationText' => 'required|min:20',
            'riskSubsectionId' => 'required|uuid|min:36',
    ...
    public function update()
    {
        ...
        $this->riskRecommendation->update([
            ...
            'risk_sub_section_id' => $this->riskSubsectionId,
        ...
        <form wire:submit.prevent="update">
            ...
            <div class="flex flex-col w-full mt-4">
                ...
                <select wire:model="riskSubsectionId" id="riskSubsectionId"
                    ...
                    @foreach ($riskQuestionText as $riskQuestion)
                        <option value="{{ $riskQuestion->id }}">{{ $riskQuestion->text }}</option>
                    @endforeach
                </select>
