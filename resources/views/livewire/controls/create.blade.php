...
<div>
    <form wire:submit.prevent="store">
        <div class="flex flex-col w-full">
            <label for="controlName" class="mb-2 text-sm font-semibold">Control Name:</label>
            <input wire:model="controlName" id="controlName" type="text"
        ...
        <div class="flex flex-col w-full mt-4">
            <label for="sectionId" class="mb-2 text-sm font-semibold">Section Name:</label>
        ...
        <x-primary-button
            class="inline-flex items-center px-4 py-2 mt-4 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2">{{ __('Save Control') }}</x-primary-button>
    </form>
    @if ($message)
