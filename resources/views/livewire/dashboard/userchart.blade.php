...
new class extends Component {
    ...
    public function emailCopy()
    {
        ...
        $riskAnalysisResponses = RiskAnalysisResponse::where('user_id', $userId)->where('attempt_number', $maxAttemptNumberRisk)->with('riskRecommendation')->get();
...
<div class="mb-4" x-data="{ successMessage: true }">
    ...
    <div class="mb-4 mt-0 w-full">
        <div
            class="min-h-8 flex items-center justify-between rounded-lg bg-white p-4 shadow-sm hover:shadow-none">
            ...
            <div class="flex-shrink-0">
                <button wire:click="emailCopy"
                    ...
                    <i
                        class="fas fa-envelope mr-1 sm:mr-2"></i>
                    ...
                    <span
                        class="hidden text-xs md:inline md:text-base">Email
    ...
    @if ($successMessage)
        <div x-show="successMessage"
            class="mb-4 rounded-b border-t-4 border-teal-500 bg-teal-100 px-4 py-3 text-teal-900 shadow-md"
            role="alert">
            <div class="flex">
                <div class="py-1"><svg
                ...
                <div>
                    ...
                    <p class="text-sm">we have sent you a
                        copy of your scores to your email
                        <span
                            class="font-bold italic">{{ auth()->user()->email }}
                            !</span>
                    </p>
                    <p class="font-bold">
                        {{ $successMessage }}</p>
                ...
                <div class="ml-auto py-1"
                    @click="successMessage = !successMessage">
                    <svg class="h-6 w-6 cursor-pointer text-teal-500"
                        xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="mb-8 w-full">
        <div
            class="min-h-8 flex flex-col items-center justify-between rounded-lg bg-white p-4 shadow-sm hover:shadow-none sm:flex-row">
            <!-- Fixed column at the start -->
            <div class="mb-4 flex-shrink-0 sm:mb-0">
                <p
                    class="sm:text-base md:text-base md:font-medium">
    ...
    <div class="mb-4 mt-2 w-full">
        <div
            class="ease grid w-full gap-4 transition-all duration-300 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3">
            <div
                class="relative rounded-3xl border-l-4 border-orange-500 bg-white p-4 shadow-xl hover:shadow-none">
                <div class="flex flex-col">
                    ...
                    <div class="flex items-start">
                        ...
                        <h3
                            class="text-wrap ml-3 text-left text-sm">
                            Activity
                            conducted by
                    ...
                    <!-- Score Percentage -->
                    <div
                        class="m-0 flex items-center justify-end p-0">
                        <svg viewBox="0 0 36 36"
                            ...
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                            <path class="circle"
                                stroke-dasharray="{{ $processorController }}, 100"
                                d="M18 2.0845
                            a 15.9155 15.9155 0 0 1 0 31.831
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                            <text x="18" y="20.35"
                                class="percentage font-bold">{{ $processorController }}
                                %</text>
                        </svg>
                    </div>
                </div>
            ...
            <div
                class="relative rounded-3xl border-l-4 border-cyan-500 bg-white p-4 shadow-xl hover:shadow-none">
                <div class="flex flex-col">
                    <!-- Heading -->
                    <div class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div
                        ...
                        <svg viewBox="0 0 36 36"
                            ...
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                            <path class="circle"
                                stroke-dasharray="{{ $personalDataProcessedByOrganisation }}, 100"
                                d="M18 2.0845
                            a 15.9155 15.9155 0 0 1 0 31.831
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                            <text x="18" y="20.35"
                                class="percentage font-bold">{{ $personalDataProcessedByOrganisation }}
                                %</text>
                        </svg>
                    </div>
                </div>
            ...
            <div
                class="relative rounded-3xl border-l-4 border-red-500 bg-white p-4 shadow-xl hover:shadow-none">
                <div class="flex flex-col">
                    <!-- Heading -->
                    <div class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div
                        ...
                        <svg viewBox="0 0 36 36"
                            ...
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                            <path class="circle"
                                stroke-dasharray="{{ $sensitivePersonalData }} , 100"
                                d="M18 2.0845
                            a 15.9155 15.9155 0 0 1 0 31.831
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                            <text x="18" y="20.35"
                                class="percentage font-bold">{{ $sensitivePersonalData }}
                                %</text>
                        </svg>
                    </div>
                </div>
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <div class="flex flex-col md:col-span-1">
            ...
            <!-- Card -->
            <div
                class="max-w-sm flex-grow overflow-hidden rounded-3xl bg-white shadow-xl hover:shadow-none">
                <div class="px-4 py-2">
                    <div
                        class="mb-2 text-center text-xl font-bold">
                        Privacy Score</div>
                </div>
                <div
                    ...
                    <p class="items-center text-center text-base font-medium text-cyan-500"
                        id="gaugeValue">
                        Average Score:</p>
                    <div
                        ...
                        <div
                            ...
                            <svg viewBox="0 0 36 36"
                                class="circular-chart green h-20 w-20">
                                <path class="circle-bg"
                                    d="M18 2.0845
                                    a 15.9155 15.9155 0 0 1 0 31.831
                                    a 15.9155 15.9155 0 0 1 0 -31.831" />
                                <path class="circle"
                                    ...
                                    a 15.9155 15.9155 0 0 1 0 -31.831" />
                                <text x="18" y="20.35"
                                    class="percentage">{{ $averageScore }}
                                    %</text>
                            </svg>
                        </div>
                        <div
                            class="flex w-1/2 items-end justify-end">
                            <p
                                class="items-end text-lg font-bold">
                                @if ($averageScore >= 75)
                                    <span
                                        style="color: green;">Low
                                        Risk</span>
        ...
        <div class="flex flex-col gap-5 md:col-span-2">
            ...
            <div
                ...
                <div
                    class="flex h-full flex-col md:col-span-1">
                    <div
                        class="relative rounded-3xl border-l-4 border-cyan-500 bg-white p-4 shadow-xl hover:shadow-none">
                        <div class="flex flex-col">
                            <!-- Heading -->
                            ...
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                                    <path class="circle"
                                        stroke-dasharray="{{ $commercialUseOfData }} , 100"
                                        d="M18 2.0845
                            a 15.9155 15.9155 0 0 1 0 31.831
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                                    <text x="18" y="20.35"
                                        class="percentage font-bold">{{ $commercialUseOfData }}
                                        %</text>
                                </svg>
                            </div>
                        </div>
                ...
                <div
                    class="flex h-full flex-col md:col-span-1">
                    <div
                        class="relative rounded-3xl border-l-4 border-green-500 bg-white p-4 shadow-xl hover:shadow-none">
                        <div class="flex flex-col">
                            <!-- Heading -->
                            <div class="flex items-start">
                                <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                                    <path class="circle"
                                        stroke-dasharray="{{ $businessOperation }}, 100"
                                        d="M18 2.0845
                            a 15.9155 15.9155 0 0 1 0 31.831
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                                    <text x="18" y="20.35"
                                        class="percentage font-bold">{{ $businessOperation }}
                                        %</text>
                                </svg>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex flex-col">
                            ...
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                                    <path class="circle"
                                        stroke-dasharray="{{ $auditScore }}, 100"
                                        d="M18 2.0845
                            a 15.9155 15.9155 0 0 1 0 31.831
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                                    <text x="18" y="20.35"
                                        class="percentage font-bold">{{ $auditScore }}
                                        %</text>
                                </svg>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex flex-col">
                            ...
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                                    <text x="18" y="20.35"
                                        class="percentage font-bold">{{ $securityScore }}
                                        %</text>
                                </svg>
                            </div>
                        </div>
    ...
    @if ($privacyCases->isNotEmpty())
        <div
            class="mb-8 mt-8 flex items-center justify-center">
            <div
                class="flex-grow border-b-4 border-[#1C4863]">
            </div>
            <span
                class="px-3 text-center text-xl font-bold">Privacy
                Cases</span>
            <div
                class="flex-grow border-b-4 border-[#1C4863]">
            </div>
        ...
        <div class="bg-white shadow-2xl hover:shadow-none">
            ...
            @foreach ($privacyCases as $privacyCase)
                <div
                    class="flex flex-row rounded-b-lg bg-white">
                    <!-- Data Row -->
                    <div class="flex flex-none items-start justify-start border-r border-gray-300 sm:p-1 md:p-4"
                        style="flex-basis: 25%;">
                    ...
                    <div class="flex flex-none items-center justify-center sm:p-1 md:p-4"
                        style="flex-basis: 25%;">
                        <a target="_blank"
                            href="{{ $privacyCase->caselink }}"
                ...
                <div
                    class="flex-grow border-b border-gray-300">
                </div>
            @endforeach
        </div>
    @endif
