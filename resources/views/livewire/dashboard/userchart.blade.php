...
new class extends Component {
    ...
    public function emailCopy()
    {
        ...
        $securityResponses = SecurityResponses::where('user_id', $userId)->where('attempt_number', $maxAttemptNumberSecurity)->with('securityRecommendation')->get();
            ...
            <div class="flex">
                ...
                <div>
                    ...
                    <p class="text-sm">we have sent you a
                        ...
                        <span class="italic font-bold">{{ auth()->user()->email }}
                            !</span>
                    </p>
                    <p class="font-bold">
                        {{ $successMessage }}</p>
                ...
                <div class="flex flex-col h-full md:col-span-1">
                    <div
                        ...
                        <div class="flex flex-col">
                            ...
                            a 15.9155 15.9155 0 0 1 0 31.831
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                                    <path class="circle" stroke-dasharray="{{ $securityScore }}, 100" d="M18 2.0845
                            a 15.9155 15.9155 0 0 1 0 31.831
                            a 15.9155 15.9155 0 0 1 0 -31.831" />
