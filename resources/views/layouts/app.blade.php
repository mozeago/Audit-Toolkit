            ...
            <div x-data="{ open: false, isOpen: false, infOpen: false, isOnboarding: false }">
                <ul>
                    ...
                    <li class="py-5 border-b border-gray-400">
                        <x-nav-link
                            class="no-border-bottom  ml-4 mr-4 block w-full py-2 text-gray-300  hover:hover:text-[#C8000B]"
                            :href="route('privacy-cases')" :active="request()->routeIs('privacy-cases')" wire:navigate>
                            <svg class="w-6 h-6 mr-2 text-gray-800 dark:hover:text-[#C8000B]" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="square" stroke-linejoin="round"
                            ...
                            <span
                                class="text-xl text-black roboto-medium hover:hover:text-[#C8000B]">{{ __('Privacy Cases') }}</span>
                        </x-nav-link>
                    </li>
                    <li class="py-5 border-b border-gray-400">
                        <x-nav-link
                            class="no-border-bottom  ml-4 mr-4 block w-full py-2 text-gray-300  hover:hover:text-[#C8000B]"
                            :href="route('guest')" :active="request()->routeIs('guest')" wire:navigate>
                            <svg class="w-6 h-6 mr-2 text-gray-800 dark:hover:text-[#C8000B]" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="square" stroke-linejoin="round"
                            ...
                            <span
                                class="text-xl text-black roboto-medium hover:hover:text-[#C8000B]">{{ __('About Contributors') }}</span>
                        </x-nav-link>
                    </li>
                </ul>
            </div>
